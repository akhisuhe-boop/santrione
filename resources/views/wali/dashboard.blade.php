    ...
    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm p-3">
        ...
        <div class="grid grid-cols-3 sm:grid-cols-3 gap-3">
            ...
            <a href="{{ route('wali.tahfidz') }}"
               class="group relative flex flex-col p-4 rounded-2xl border border-slate-100 bg-cyan-50/60 shadow-[0_1px_2px_rgba(15,23,42,0.04)] hover:shadow-[0_10px_28px_-6px_rgba(15,23,42,0.12)] hover:-translate-y-0.5 transition-all duration-200">
                ...
                <div class="font-semibold text-[14px] leading-snug text-slate-900">Tahfidz</div>

            </a>

            {{-- ABSENSI --}}
            <a href="{{ route('wali.absensi') }}"
               class="group relative flex flex-col p-4 rounded-2xl border border-slate-100 bg-blue-50/60 shadow-[0_1px_2px_rgba(15,23,42,0.04)] hover:shadow-[0_10px_28px_-6px_rgba(15,23,42,0.12)] hover:-translate-y-0.5 transition-all duration-200">
                ...
                <div class="font-semibold text-[14px] leading-snug text-slate-900">Absensi</div>

            </a>

            {{-- PELANGGARAN --}}
            <a href="{{ route('wali.pelanggaran') }}"
               class="group relative flex flex-col p-4 rounded-2xl border border-slate-100 bg-orange-50/60 shadow-[0_1px_2px_rgba(15,23,42,0.04)] hover:shadow-[0_10px_28px_-6px_rgba(15,23,42,0.12)] hover:-translate-y-0.5 transition-all duration-200">
                ...
                <div class="font-semibold text-[14px] leading-snug text-slate-900">Pelanggaran</div>

            </a>

            {{-- PRESTASI --}}
            <a href="{{ route('wali.prestasi') }}"
               class="group relative flex flex-col p-4 rounded-2xl border border-slate-100 bg-yellow-50/60 shadow-[0_1px_2px_rgba(15,23,42,0.04)] hover:shadow-[0_10px_28px_-6px_rgba(15,23,42,0.12)] hover:-translate-y-0.5 transition-all duration-200">
                ...
                <div class="font-semibold text-[14px] leading-snug text-slate-900">Prestasi</div>

            </a>

            {{-- PERIZINAN --}}
            <a href="{{ route('wali.perizinan') }}"
               class="group relative flex flex-col p-4 rounded-2xl border border-slate-100 bg-violet-50/60 shadow-[0_1px_2px_rgba(15,23,42,0.04)] hover:shadow-[0_10px_28px_-6px_rgba(15,23,42,0.12)] hover:-translate-y-0.5 transition-all duration-200">
                ...
                <div class="font-semibold text-[14px] leading-snug text-slate-900">Perizinan</div>

            </a>

            {{-- IZIN TIDAK MASUK --}}
            <a href="{{ route('wali.izin-tidak-masuk') }}"
               class="group relative flex flex-col p-4 rounded-2xl border border-slate-100 bg-amber-50/60 shadow-[0_1px_2px_rgba(15,23,42,0.04)] hover:shadow-[0_10px_28px_-6px_rgba(15,23,42,0.12)] hover:-translate-y-0.5 transition-all duration-200">
                ...
                <div class="font-semibold text-[14px] leading-snug text-slate-900">Izin Sekolah</div>

            </a>

            {{-- RAPORT --}}
            <a href="{{ route('wali.raport') }}"
               class="group relative flex flex-col p-4 rounded-2xl border border-slate-100 bg-emerald-50/60 shadow-[0_1px_2px_rgba(15,23,42,0.04)] hover:shadow-[0_10px_28px_-6px_rgba(15,23,42,0.12)] hover:-translate-y-0.5 transition-all duration-200">
                ...
                <div class="font-semibold text-[14px] leading-snug text-slate-900">Raport</div>
            ...
            <a href="{{ route('wali.kantin') }}"
               class="group relative flex flex-col p-4 rounded-2xl border border-slate-100 bg-rose-50/60 shadow-[0_1px_2px_rgba(15,23,42,0.04)] hover:shadow-[0_10px_28px_-6px_rgba(15,23,42,0.12)] hover:-translate-y-0.5 transition-all duration-200">
                ...
                <div class="font-semibold text-[14px] leading-snug text-slate-900">Kantin</div>
