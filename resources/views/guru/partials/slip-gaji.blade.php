{{-- Partial 1 slip gaji -- dipakai berulang di guru/gaji.blade.php kalau
     pegawai punya lebih dari 1 payroll bulan yang sama (Struktural &
     Fungsional dipisah). Variabel: $pegawai, $payroll (bisa null),
     $labelJenis (string|null, mis. 'Struktural'/'Fungsional'),
     $riwayatMengajar (collection, default kosong). --}}
